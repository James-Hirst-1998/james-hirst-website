...
const Detectree = React.forwardRef((props, ref) => {
    return (
        <div style={{ padding: "20px 20px" }}>
            <shared.mainStyledDiv ref={ref} style={{ backgroundColor: "#99e699", fontSize: "14px", maxWidth: "550px" }}>
                <h3>Detectree Project</h3>
                <p>
                    I utilised <b>machine learning</b> to help gather results for a paper with
                    ...
                    This in turn will give better estimates on the carbon stored in forests than the current estimates which use landmass.
                    I conducted machine learning on a variety of different forest datasets and used Facebook's Detectron2 to
