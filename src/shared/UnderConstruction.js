        ...
        return (
            <div className="Construction" style={{ display: "flex", flexDirection: "row", justifyContent: "center", flexWrap: "wrap", padding: "0px 10px 0px 10px" }}>
                <shared.paraBody ref="Construction"
                    ...
                    to this section soon. Please refer to my <a href="https://github.com/James-Hirst-1998/james-hirst-website/blob/Main/src/CV.pdf">CV</a> if you are interested in finding
                    out more about me.
                </shared.paraBody>
            </div>
        );
